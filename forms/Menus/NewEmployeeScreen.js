...
export default class NewEmployeeScreen extends Component<{}> {
  state={
      selected: 0
    }
  render() {
                 ...
                 <Content>
                    ...
                    <Button
                      ...
                      <Form style={{flex: 1,flexDirection: 'row', marginLeft:270}}>
                        <InputGroup>
                          <Item style={{backgroundColor:'red',width:350,marginTop:5,height:50,}}>
                              <Text style={{fontSize:24,fontWeight:'bold',marginTop:-20,marginLeft:5,textDecorationLine:'underline'}}>EMPLOYEE INFORMATION</Text>
                              <Text style={{fontSize:20,fontWeight:'bold',marginTop:30, marginLeft:-290}}>As of {txtdate_}</Text>
                          </Item>
                        </InputGroup>
                        <InputGroup>
                    ...
                    <InputGroup style={{marginLeft:10,marginTop:-40,borderColor:'#ecf0f1'}}>
                      <Segment style={{backgroundColor:'#ecf0f1', borderColor:'#ecf0f1',width:250,}}>
                        <Button
                            ...
                            <Text style={{color:'black',fontWeight:'bold'}}>PERSONEL INFO</Text>
                        </Button>
                      </Segment>
                    </InputGroup>
                    <InputGroup style={{marginLeft:10,marginTop:5,borderColor:'#ecf0f1'}}>
                      <Segment style={{backgroundColor:'#ecf0f1', borderColor:'#ecf0f1',width:250,}}>
                        <Button
                            ...
                            <Text style={{color:'black'}}>PAY INFO</Text>
                        </Button>
                    </Segment>
                    </InputGroup>
                    <InputGroup style={{marginLeft:10,marginTop:5, borderColor:'#ecf0f1'}}>
